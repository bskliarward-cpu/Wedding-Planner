...
async function pasteFromClipboard() {
  // Mobile browser: clipboard.read() hangs unreliably — go straight to the paste target
  if (/Android|iPhone|iPad|iPod|Mobile/i.test(navigator.userAgent)) { showPasteTarget(); return; }
